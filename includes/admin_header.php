...
<head>
    ...
    <style>
        ...
        #sidebar {
            width: 260px;
            height: 100vh; /* Thuật ngữ: Viewport Height - Cao bằng màn hình rứa */
            background: var(--sidebar-bg);
            color: #fff;
            position: fixed; /* Thuật ngữ: Fixed Positioning - Cố định vị trí mô */
            top: 0;
            left: 0;
            z-index: 1000;
            transition: var(--transition-smooth);
            display: flex;
            flex-direction: column; /* Sắp xếp theo chiều dọc rứa */
        }
            ...
            #sidebar .sidebar-header {
                ...
                flex-shrink: 0; /* Không bị co lại khi menu dài rứa mô */
            }

        .sidebar-menu-wrapper {
            flex-grow: 1;
            overflow-y: auto; /* Thuật ngữ: Overflow-Y Auto - Cho phép cuộn dọc mô */
            scrollbar-width: thin; /* Cho Firefox rứa */
            scrollbar-color: rgba(255,255,255,0.1) transparent;
        }

            /* Tùy chỉnh thanh cuộn cho lẫm liệt rứa - Thuật ngữ: Custom Scrollbar mô */
...
<div class="d-flex">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header">
            ...
            <small class="text-muted">Chào Bạn, <?= htmlspecialchars($name) ?> nha!</small>

        </div>

        <ul class="list-unstyled mt-3 sidebar-menu-wrapper" >
            ...
            <li><a href="manage_order.php"><i class="fa-solid fa-cart-shopping"></i> Quản lý đơn hàng</a></li>
